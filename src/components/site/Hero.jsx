...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[100svh] flex items-center justify-center overflow-hidden py-0">
      {/* Background Image (fixé seulement desktop) */}
      <div
        className="absolute inset-0 -z-10 bg-cover bg-center md:bg-fixed pointer-events-none"
        style={{
          backgroundImage:
            "linear-gradient(rgba(15,23,42,0.40), rgba(15,23,42,0.60)), url('https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&w=1920&q=80')",
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="font-body text-xl sm:text-2xl mt-6 mb-12 text-gray-100 max-w-2xl mx-auto leading-relaxed">
          {t("hero.subtitle")}
        </p>
